...
import logo  from '../public/assets/nav2.png'
          ...
          <div className='w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left'>
            <Link href={"/"}>
              <div className='flex title-font font-medium items-center md:justify-start justify-center text-gray-900 cursor-pointer'>
                <Image src={logo} alt='..' width={200} height={20} />
                {/* <span className="ml-3 text-xl"></span> */}
              </div>
            </Link>
            <p className='mt-2 px-4 text-sm text-gray-500'>
              "Be Bold, Be Beautiful, Be You "<br /> with Womeni
              {" "}
            </p>
          </div>
          <div className='flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center'>
            <div className='lg:w-1/4 md:w-1/2 w-full px-4'>
              ...
              <nav className='list-none mb-10'>
                <li>
                  <Link legacyBehavior href={"/New_In"}>
                    <a className='text-gray-500 hover:text-gray-800'>New_In</a>
                  </Link>
                </li>
                <li>
                  <Link legacyBehavior href={"/Tops"}>
                    <a className='text-gray-500 hover:text-gray-800'>Tops</a>
                  </Link>
                </li>
                <li>
                  <Link legacyBehavior href={"/Dresses"}>
                ...
                <li>
                  <Link legacyBehavior href={"/party-wear"}>
                    <a className='text-gray-500 hover:text-gray-800'>Party-Wear</a>
                  </Link>
                </li>
              </nav>
            </div>
